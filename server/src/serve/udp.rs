...
const MAX_STATES_PER_PACKET: usize = 31;
...
pub async fn handle_packet(
    ...
    (header_bytes, zone, id, player_state): ([u8; HEADER_LEN], u32, u8, PlayerState),
    ...
    let filtered_state = state.lock().unwrap().filtered_state(zone, id);
